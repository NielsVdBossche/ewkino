...
TriggerInfo::TriggerInfo( const TreeReader& treeReader,
	...
	_containsIndividualTriggers = true;
	...
	_containsCompositeTriggers = true;
	...
	if( treeReader.is2018() ){
	    ...
	    if( stringTools::stringContains(treeReader.currentSamplePtr()->filePath(),"Run2018A") ){
		if( treeReader._triggerMap.count("HLT_TripleMu_5_3_3_Mass3p8_DZ")==0 ){
