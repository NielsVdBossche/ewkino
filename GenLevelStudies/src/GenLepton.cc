...
GenLepton::GenLepton(const TreeReader& treeReader, const unsigned leptonIndex) : 
    PhysicsObject(treeReader._gen_lPt[leptonIndex], treeReader._gen_lEta[leptonIndex], treeReader._gen_lPhi[leptonIndex], treeReader._gen_lE[leptonIndex], treeReader.is2016(), treeReader.is2016PreVFP(), treeReader.is2016PostVFP(), treeReader.is2017(), treeReader.is2018()),
