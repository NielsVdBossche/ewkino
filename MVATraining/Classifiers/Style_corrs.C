// Mainframe macro generated from application: /home/njovdnbo/root/bin/root.exe
// By ROOT version 6.24/06 on 2022-09-01 17:02:09
...
void Style_corrs()
{
   ...
   tmpStyle->SetPadBottomMargin(0.21);
   tmpStyle->SetPadTopMargin(0.02);
   tmpStyle->SetPadLeftMargin(0.12);
