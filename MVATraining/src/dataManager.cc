...
std::pair<Double_t*, std::vector<Double_t>*> mvaDataManager::prepareTTree(TTree* chain, mvaConfiguration config) {
    ...
    *weight = 1.; // unless changed elsewhere
    ...
    if ( config == BDT_DL || config == NN_DL || config == BDT_ML || config == NN_ML) {
        ...
        chain->SetBranchAddress("bTagSub",          &dataVector->at(6));
        chain->SetBranchAddress("bTagThird",        &dataVector->at(7));
        //chain->SetBranchAddress("bTagFourth",       &dataVector->at(17));
        chain->SetBranchAddress("bTagPtLead",       &dataVector->at(8));
        chain->SetBranchAddress("bTagPtSub",        &dataVector->at(9));
        chain->SetBranchAddress("bTagPtThird",      &dataVector->at(10));
        chain->SetBranchAddress("bTagPtFourth",     &dataVector->at(11));
        ...
        chain->SetBranchAddress("mtLeadLepMET",     &dataVector->at(12));
        chain->SetBranchAddress("mtSubLeadLepMET",  &dataVector->at(13));
        chain->SetBranchAddress("massBestTop",      &dataVector->at(14));
        //chain->SetBranchAddress("massBestTopW",     &dataVector->at(31));
        chain->SetBranchAddress("massSecTop",       &dataVector->at(15));
        //chain->SetBranchAddress("massSecTopW",      &dataVector->at(33));
    }

    if (config == BDT_DL || config == NN_DL) {
        chain->SetBranchAddress("N_jets",           &dataVector->at(16));
        chain->SetBranchAddress("ht",               &dataVector->at(17));
        chain->SetBranchAddress("pt_jet_six",       &dataVector->at(18));
        chain->SetBranchAddress("bTagLead",         &dataVector->at(19));
    ...
    if (config == BDT_ML || config == NN_ML) {
        chain->SetBranchAddress("pt_lep_one",       &dataVector->at(16));
        //chain->SetBranchAddress("m2bb",             &dataVector->at(22));
        //chain->SetBranchAddress("m2lblb",           &dataVector->at(25));
        chain->SetBranchAddress("pt_jet_five",      &dataVector->at(17));
        chain->SetBranchAddress("pt_lep_three",     &dataVector->at(18));
    }
