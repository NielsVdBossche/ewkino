...
std::pair<Double_t*, std::vector<Double_t>*> mvaDataManager::prepareTTree(TTree* chain, mvaConfiguration config) {
    ...
    *weight = 1.; // unless changed elsewhere
    ...
    if (config == BDT_DL || config == NN_DL) {
        ...
        chain->SetBranchAddress("ht",               &dataVector->at(13));
        chain->SetBranchAddress("pt_jet_six",       &dataVector->at(14));
        chain->SetBranchAddress("pt_lep_two",       &dataVector->at(15));
        chain->SetBranchAddress("bTagLead",         &dataVector->at(16));
        chain->SetBranchAddress("bTagThird",        &dataVector->at(17));
    ...
    if (config == BDT_ML || config == NN_ML) {
        chain->SetBranchAddress("pt_lep_one",       &dataVector->at(13));
        //chain->SetBranchAddress("m2bb",             &dataVector->at(22));
        //chain->SetBranchAddress("m2lblb",           &dataVector->at(25));
        chain->SetBranchAddress("pt_jet_five",      &dataVector->at(14));
        chain->SetBranchAddress("pt_lep_three",     &dataVector->at(15));
    }
