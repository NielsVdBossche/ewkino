...
std::pair<Double_t*, std::vector<Double_t>*> mvaDataManager::prepareTTree(TTree* chain, mvaConfiguration config) {
    ...
    *weight = 1.; // unless changed elsewhere
    ...
    if (config == BDT_DL || config == NN_DL) {
        ...
        chain->SetBranchAddress("sec_min_dr_lep_b", &dataVector->at(5));
        ...
        chain->SetBranchAddress("pt_lep_two",       &dataVector->at(8));
        chain->SetBranchAddress("bTagLead",         &dataVector->at(9));
        chain->SetBranchAddress("bTagSub",          &dataVector->at(10));
        chain->SetBranchAddress("bTagThird",        &dataVector->at(11));
        //chain->SetBranchAddress("bTagFourth",       &dataVector->at(16));
        chain->SetBranchAddress("bTagPtLead",       &dataVector->at(12));
        chain->SetBranchAddress("bTagPtSub",        &dataVector->at(13));
        chain->SetBranchAddress("bTagPtThird",      &dataVector->at(14));
        chain->SetBranchAddress("bTagPtFourth",     &dataVector->at(15));
        chain->SetBranchAddress("m2ll",             &dataVector->at(16));
        chain->SetBranchAddress("m2bb",             &dataVector->at(17));
        //chain->SetBranchAddress("m2lblb",           &dataVector->at(24));
        chain->SetBranchAddress("mtLeadLepMET",     &dataVector->at(18));
        chain->SetBranchAddress("mtSubLeadLepMET",  &dataVector->at(19));
        chain->SetBranchAddress("massBestTop",      &dataVector->at(20));
        //chain->SetBranchAddress("massBestTopW",     &dataVector->at(27));
        chain->SetBranchAddress("massSecTop",       &dataVector->at(21));
        chain->SetBranchAddress("MET",              &dataVector->at(22));
    ...
    if (config == BDT_ML || config == NN_ML) {
        ...
        chain->SetBranchAddress("pt_lep_one",       &dataVector->at(7));
        chain->SetBranchAddress("pt_lep_two",       &dataVector->at(8));
        chain->SetBranchAddress("bTagLead",         &dataVector->at(9));
        chain->SetBranchAddress("bTagSub",          &dataVector->at(10));
        chain->SetBranchAddress("bTagThird",        &dataVector->at(11));
        ...
        chain->SetBranchAddress("pt_lep_three",     &dataVector->at(22));
