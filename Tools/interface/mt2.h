...
namespace mt2{
    ...
    double mt2bb(const PhysicsObject&, const PhysicsObject&, const PhysicsObject&, const PhysicsObject&, const Met&);
    double mt2lblb(const PhysicsObject&, const PhysicsObject&, const PhysicsObject&, const PhysicsObject&, const Met&);
}
