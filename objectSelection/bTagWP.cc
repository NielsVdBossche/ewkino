...
double bTagWP::looseDeepFlavor2016PreVFP() {return 0.0480;}
double bTagWP::mediumDeepFlavor2016PreVFP() {return 0.2489;}
double bTagWP::tightDeepFlavor2016PreVFP() {return 0.6377;}
