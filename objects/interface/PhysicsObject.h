...
class PhysicsObject{
    ...
    public:
        ...
        PhysicsObject( double transverseMomentum, double pseudoRapidity, double azimuthalAngle, double energy, const bool objectIs2016PreVFP = false, const bool objectIs2016PostVFP = false, const bool objectIs2017 = false );
        ...
        bool is2016() const{ return (is2016PostVFPObject || is2016PreVFPObject); }
        ...
        bool is2018() const{ return !( is2016PostVFPObject || is2016PreVFPObject || is2017Object ); }
