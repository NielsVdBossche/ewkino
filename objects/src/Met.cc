...
Met::Met(const NanoReader& nanoReader, const bool readAllJECVariations, const bool readGroupedJECVariations) :
    PhysicsObject( nanoReader.isMC() ? nanoReader._MET_T1Smear_pt : nanoReader._MET_T1_pt, 0., 
                   nanoReader.isMC() ? nanoReader._MET_T1Smear_phi : nanoReader._MET_T1_phi,
                   nanoReader.isMC() ? nanoReader._MET_T1Smear_pt : nanoReader._MET_T1_pt,
		    nanoReader.is2016(), nanoReader.is2016PreVFP(), nanoReader.is2016PostVFP(),
		    nanoReader.is2017(), nanoReader.is2018() ),
    _pt_JECDown(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_jesTotalDown : 0.),
    _phi_JECDown(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_jesTotalDown : 0.),
    _pt_JECUp(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_jesTotalUp : 0.),
    _phi_JECUp(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_jesTotalUp : 0.),
    _pt_UnclDown(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_unclustEnDown : 0.),
    _phi_UnclDown(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_unclustEnDown : 0.),
    _pt_UnclUp(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_unclustEnUp : 0.),
    _phi_UnclUp(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_unclustEnUp : 0.),
    _pt_JER1p93Down(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_jer0Down : 0.),
    _phi_JER1p93Down(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_jer0Down : 0.),
    _pt_JER1p93Up(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_jer0Up : 0.),
    _phi_JER1p93Up(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_jer0Up : 0.),
    _pt_JER2p5Down(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_jer1Down : 0.),
    _phi_JER2p5Down(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_jer1Down : 0.),
    _pt_JER2p5Up(nanoReader.isMC() ? nanoReader._MET_T1Smear_pt_jer1Up : 0.),
    _phi_JER2p5Up(nanoReader.isMC() ? nanoReader._MET_T1Smear_phi_jer1Up : 0.),
    _metVariationsInitialized(true),
